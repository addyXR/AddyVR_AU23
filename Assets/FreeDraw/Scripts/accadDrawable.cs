...
namespace FreeDraw
{
    ...
    public class accadDrawable : MonoBehaviour
    {
        ...
        public static accadDrawable drawable;
...
//////////////////////////////////////////////////////////////////////////////
        ...
        void Update()
        {
            ...
            if (cs.canDraw && !no_drawing_on_current_drag)
            {
                // Convert mouse coordinates to world coordinates
                Vector2 VRpen_world_position = cs.pointsTransform.position;
                // Check if the current mouse position overlaps our image
                Collider2D hit = Physics2D.OverlapPoint(VRpen_world_position, Drawing_Layers.value);
                if (hit != null && hit.transform != null)
                {
                    // We're over the texture we're drawing on!
                    // Use whatever function the current brush is
                    current_brush(VRpen_world_position);
                }
            ...
            mouse_was_previously_held_down = cs.canDraw;
        }
